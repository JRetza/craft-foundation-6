...
<p class="lead">Problem: You've got tons of content, each needing different sized vertical cell, and don't know how to quick and easily get it all done. Solution: The awesome grid!</p>

---

## Overview

The grid is built around two key elements: grid-xs and cell. grid-xs create a max-width and contain the cell, and cell create the final structure. Everything on your page that you don't give a specific structural style to should be within a grid-x or column.

---

## Nesting

In the Grid you can nest cell down as far as you'd like. Just embed grid-xs inside cell and go from there. Each embedded grid-x can contain up to 12 cell.

---

## How to Use

Using this framework is easy. Here's how your code will look when you use a series of `<div>` tags to create vertical cell.
...
In the Grid you can nest cell down as far as you'd like. Just embed grid-x inside cell and go from there. Each embedded grid-x can contain up to 12 cells.
...
- You can create grid-x elements inside your form and use cell for the form, including inputs, labels and more. grid-xs inside a form inherit some special padding to even up input spacing.
